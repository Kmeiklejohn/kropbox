# Generated by Django 2.2 on 2019-04-08 14:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.FileField(upload_to=mptt.fields.TreeForeignKey(on_delete=django.db.models.deletion.CASCADE, to='manager.Folder'))),
                ('created_at', models.DateTimeField(auto_now_add=True)),
